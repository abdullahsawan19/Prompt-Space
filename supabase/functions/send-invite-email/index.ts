                    ...
                    <tr>
                      <td style="padding: 40px 30px;">
                        ...
                        <div style="text-align: center; margin-bottom: 20px;">
                          <a href="https://prompt-space-phi.vercel.app/accept-invite?email=${inviteRecord.email}&workspace=${inviteRecord.workspace_id}" 
                        ...
                        <p style="margin: 30px 0 0 0; text-align: center; font-size: 14px; color: #9ca3af;">
                          (or copy & paste: https://prompt-space-phi.vercel.app/ )
                        </p>
