...
const BottomCTA = () => {
  return (
    <section className="my-12 md:my-16 max-w-7xl mx-auto px-4 sm:px-6">
      <div className="py-10 px-6 md:py-14 md:px-12 rounded-3xl bg-[var(--color-brand-600)] text-[#fff] text-center shadow-[var(--shadow-lg)] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black mb-4 md:mb-5 tracking-tight">
            Ready to boost your productivity?
          </h2>
          <p className="text-base md:text-lg text-[var(--color-grey-100)] mb-8 font-medium opacity-90">
